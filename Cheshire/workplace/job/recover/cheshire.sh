...
do
    ...
    do
        ...
        job_name="${model}_cheshire_recover_${train_split}_${remove}"
...
python main.py --name "$model" --repeat 5 --model "CHESHIRE" --train_split $train_split --remove "$remove" --max_epoch 100 --recover 
