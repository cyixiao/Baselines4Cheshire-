...
do
    ...
    do
        ...
        job_name="${model}_nhp_recover_${train_split}_${remove}"
...
python main.py --name "$model" --repeat 5 --model "NHP" --lr 0.001 --emb_dim 512 --conv_dim 256 --train_split $train_split --remove "$remove" --max_epoch 100 --recover 
